...
async function runScript() {
    try {
        await main();
        console.log('Script completed. Waiting for 12 hours before restarting...');
    } catch (error) {
        console.error('Script failed. Restarting in 12 hours...', error);
    } finally {
        setTimeout(() => {
            console.log('Restarting script after 12 hours...');
            runScript();
